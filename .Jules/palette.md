...
## 2026-05-16 - Calendar View Mode Accessibility
...
**Action:** Add `role='group'` to toggle wrappers, `aria-pressed={isActive}` to view mode buttons, and `aria-expanded` to the custom interval dropdown toggle in CalendarView.
