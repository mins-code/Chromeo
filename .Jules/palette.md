...
## 2024-07-03 - Segmented Control ARIA
...
**Action:** Use a wrapper with `role='group'` and `aria-pressed={isActive}` on the active `<button>`. Dropdown toggles must explicitly define `aria-expanded` and `aria-haspopup`.
