...
## 2026-06-10 - Optimize multiple inline array reductions
**Learning:** Inline array reductions (like chained `.filter().reduce()`) inside React JSX render functions execute O(K*N) operations on every re-render.
