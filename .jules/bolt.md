...
## 2026-03-04 - Date Formatting Optimization
**Learning:** Caching Intl.DateTimeFormat instances and using native JS string concatenation for YYYY-MM-DD date strings avoids severe O(N) object instantiation overhead and is ~50-100x faster than un-cached methods in tight render loops.
**Action:** Always cache Intl.DateTimeFormat instances and prefer inline string padding for critical path date generation.
