...
const CalendarView: React.FC<CalendarViewProps> = ({ tasks, onDateClick, onEditTask }) => {
    ...
    const doesTaskOccurOnDate = useCallback((task: Task, date: Date): boolean => {
        ...
        return false;
    }, []); // Empty deps since function logic doesn't depend on component state
                    ...
                    <div className="relative w-full max-w-md glass rounded-2xl shadow-2xl overflow-hidden animate-scale-in flex flex-col max-h-[70vh]">
                        ...
                        <div className="flex-1 overflow-y-auto p-4 space-y-3">
                            ...
                            {selectedDayTasks.map(task => (
                                ...
                                >
                                    <div className={`mt-1 w-2 h-2 rounded-full flex-shrink-0 ${task.priority === TaskPriority.HIGH ? 'bg-red-500' :
