...
const ResultIcon: React.FC<{ type: SearchResult['type']; className?: string }> = ({
  type,
  className,
}) => {
  switch (type) {
    ...
    <div className="fixed inset-0 z-[100] flex items-start justify-center pt-[15vh] p-4">
      ...
      <div className="relative w-full max-w-2xl animate-scale-in">
        <div className="bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-slate-200 dark:border-white/10 overflow-hidden">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-slate-500">
                {isListening
                  ...
                  : 'Search or describe a task in natural language'}
              </p>
            </div>
            <button
              onClick={onClose}
          ...
          <form onSubmit={handleSubmit} role="search">
            <div className="relative flex items-center">
              <input
                ...
                placeholder={
                  isListening ? 'Listening...' : 'Search tasks, notes, pages... or create new task'
                }
                disabled={isLoading}
          ...
          {/* Search Results */}
          {results.length > 0 && (
            <div ref={resultsRef} className="border-t border-slate-200 dark:border-white/5">
              <div className="px-4 py-2 text-xs font-medium text-slate-500 uppercase tracking-wider flex items-center gap-2">
                <Search size={12} />
                Jump To
              </div>
              <div className="pb-2" id={listboxId} role="listbox">
            ...
            <div className="border-t border-slate-200 dark:border-white/5">
              ...
              >
                ...
                {isLoading ? (
                  ...
                  <kbd className="px-1.5 py-0.5 rounded bg-slate-200 dark:bg-slate-700 font-mono text-[10px] text-slate-500">
                    Enter
                  </kbd>
                )}
              </button>
