        ...
        <div className={`h-screen w-screen overflow-hidden font-sans transition-colors duration-500`}>
            ...
            <div className="flex h-full w-full bg-gradient-main text-slate-800 dark:text-slate-200">
                ...
                <div className="flex-1 flex flex-col h-full overflow-hidden relative">
                    ...
                    {/* TOP Header */}
                    <header className="min-h-32 md:min-h-20 glass border-b border-slate-200 dark:border-white/5 flex items-center justify-between px-6 pb-8 md:pb-0 z-30 shrink-0 pt-safe-area">
                        {/* Brand */}
