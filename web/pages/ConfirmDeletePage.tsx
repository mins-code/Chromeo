          ...
          {status === 'confirming' && (
            <div className="space-y-6">
              <div className="bg-red-50 dark:bg-red-500/10 rounded-xl p-4 border border-red-200 dark:border-red-500/20">
                <h3 className="font-bold text-red-700 dark:text-red-400 mb-2">⚠️ Final Warning</h3>
              ...
              <div className="flex gap-3">
                ...
                <Button variant="danger" onClick={handleConfirmDeletion} className="flex-1">
                  Delete My Account
                </Button>
              </div>
            </div>
          ...
          {status === 'error' && (
            <div className="text-center py-8">
              ...
              <div className="flex gap-3 justify-center">
                ...
                <Button onClick={() => setStatus('confirming')}>Try Again</Button>
              </div>
            </div>
          )}
