...
// ⚡ Bolt Optimization: Cache Intl.DateTimeFormat instances to avoid O(N) overhead
...
const weekdayDateFormatterUS = new Intl.DateTimeFormat('en-US', { weekday: 'long', month: 'long', day: 'numeric' });
