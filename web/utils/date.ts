...
const formatterShort = new Intl.DateTimeFormat(undefined, { month: 'short', day: 'numeric' });
const formatterLong = new Intl.DateTimeFormat(undefined, { year: 'numeric', month: 'long', day: 'numeric' });
const formatterWeekday = new Intl.DateTimeFormat(undefined, { weekday: 'long', month: 'long', day: 'numeric' });
const formatterWeekdayUS = new Intl.DateTimeFormat('en-US', { weekday: 'long', month: 'long', day: 'numeric' });
const formatterNumeric = new Intl.DateTimeFormat();
const formatterTime = new Intl.DateTimeFormat(undefined, { hour: '2-digit', minute: '2-digit' });
const formatterTime24 = new Intl.DateTimeFormat(undefined, { hour: '2-digit', minute: '2-digit', hour12: false });
const formatterDateTimeLong = new Intl.DateTimeFormat(undefined, { year: 'numeric', month: 'long', day: 'numeric', hour: '2-digit', minute: '2-digit' });
...
export const formatDateShort = (date: string | Date): string => {
  ...
  return formatterShort.format(d);
};
...
export const formatDateWithWeekday = (date: string | Date): string => {
  const d = parseDate(date);
  if (Number.isNaN(d.valueOf())) return 'Invalid Date';
  return formatterWeekday.format(d);
};
...
export const formatDateWithWeekdayUS = (date: string | Date): string => {
  const d = parseDate(date);
  if (Number.isNaN(d.valueOf())) return 'Invalid Date';
  return formatterWeekdayUS.format(d);
};
...
export const formatDateNumeric = (date: string | Date): string => {
  const d = parseDate(date);
  if (Number.isNaN(d.valueOf())) return 'Invalid Date';
  return formatterNumeric.format(d);
};
...
export const formatTime24 = (date: string | Date): string => {
  const d = parseDate(date);
  if (Number.isNaN(d.valueOf())) return 'Invalid Date';
  return formatterTime24.format(d);
};
...
export const formatDateTimeLong = (date: string | Date): string => {
  const d = parseDate(date);
  if (Number.isNaN(d.valueOf())) return 'Invalid Date';
  return formatterDateTimeLong.format(d);
};
